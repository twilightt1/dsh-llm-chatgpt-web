...
import { a as loadManagedNativeRuntimeConfig, f as ManagedRuntimeConfigurationError, m as ManagedTunnelRuntime, p as ManagedRuntimeTransportError, r as defaultNativeRuntimeConfigPath } from "./chunks/runtime-config-CgMXXI4k.js";
import { t as NativeBrokerSocketServer } from "./chunks/broker-socket-BcrCgxlt.js";
...
function resolveMcpEntrypoint(explicit) {
	...
	const candidate = [join(current, "mcp-main.js"), join(current, "../../lib/mcp-main.js")].find((path) => {
		try {
	...
	if (realCandidate !== realRoot && !realCandidate.startsWith(`${realRoot}/`)) throw new ManagedRuntimeConfigurationError("built lib/mcp-main.js resolves outside the package root");
...
*/
function resolveAdapterOptions(config, platform = process.platform) {
