...
async function* streamTextTurn(page, options) {
	...
	*/
	...
	return {
		text: yield* captureRound(await submit(initialAssistantTurns)),
...
//#endregion
export { ChatGptWebAdapter, Config, PROVIDER, apply, compilePrompt, defaultBrokerSocketPath, inject, name, resolveAdapterOptions };
